...
def get_score(s, player_idx):
    chess_type = [[],
                  ['11111', '011110', '1111', '11101', '11011', '10111', '01110', '0111', '1011', '1101', '0110', '11',
                   '101','1110'],
                  ['22222', '022220', '2222', '22202', '22022', '20222', '02220', '0222', '2022', '2202', '0220', '22',
                   '202','2220']]
    ...
    if (chess_type[player_idx][0] in s):
        ...
        return 5000
    elif ((chess_type[player_idx][7] in s) or (chess_type[player_idx][8] in s) or (chess_type[player_idx][9] in s)or(chess_type[player_idx][13] in s)):
        return 1000
...
def my_controller(observation, action_space, is_act_continuous=False):
    ...
    final_score = maxmin_decision(depth=0, is_opponent=False, available_attempt=initial_available_attempt(), alpha=-1e9,
                                  beta=1e9)
    output = [[0] * 15, [0] * 15]
    output[0][ans[0]] = 1
    output[1][ans[1]] = 1
